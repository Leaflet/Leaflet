...
Weighing in at about 39 KB of gzipped JS plus 4 KB of gzipped CSS code, it has all the mapping [features][] most developers ever need.

Leaflet was designed with *simplicity*, *performance* and *usability* in mind.
It works efficiently across all major desktop and mobile platforms out of the box,
taking advantage of HTML5 and CSS3 on modern browsers while being accessible on older ones too.
It has an easy-to-use and [well-documented][] API,
can be extended with a large number of [plugins][],
and the [source code][] is a joy to [contribute][] to.
