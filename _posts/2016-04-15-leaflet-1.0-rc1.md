...
Leaflet 1.0-rc1 closes down on edge cases and API inconsistencies that were present on beta2. The full list of changes in the [1.0.0-rc1 changelog](https://github.com/Leaflet/Leaflet/blob/master/CHANGELOG.md#10-beta2-october-14-2015) as usual, with about 50 bugfixes and a dozen improvements and minor API changes.
