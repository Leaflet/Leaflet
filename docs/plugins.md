...
<table class="plugins"><tr><th>Plugin</th><th>Description</th><th>Maintainer</th></tr>
	<tr>
		<td>
			<a href="https://github.com/mocnik-science/geogrid.js">geogrid.js</a>
		</td><td>
			Displays data aggregated by the ISEA3H discrete global grid system.  The data can, e.g., be delived by using <a href="https://github.com/mocnik-science/geogrid">geogrid</a> (a library for handling the grid in case that you want to aggregate data manually) or <a href="https://github.com/giscience/measures-rest">Measures REST</a> (a framework to deliver data aggregated by the grid).
		</td><td>
			<a href="http://www.mocnik-science.net">F.-B. Mocnik,</a><br>GIScience Research Group,<br>Heidelberg University
		</td>
	</tr>
	<tr>
		<td>
