...
export var androidStock = isBrowser && android && userAgentContains('Google') && webkitVer < 537 && !('AudioNode' in window);
...
export var mobile = isBrowser && typeof orientation !== 'undefined' || userAgentContains('mobile');
...
export var passiveEvents = (function () {
	...
	try {
		...
		isBrowser && window.addEventListener('testPassiveEventSupport', Util.falseFn, opts);
		isBrowser && window.removeEventListener('testPassiveEventSupport', Util.falseFn, opts);
	} catch (e) {
