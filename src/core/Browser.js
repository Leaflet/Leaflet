...
const mac = typeof navigator === 'undefined' || typeof navigator?.userAgent === 'undefined' ? false : navigator.userAgent.indexOf('Mac') !== -1;

// @property mac: Boolean; `true` when the browser is running in a Linux platform
const linux = typeof navigator === 'undefined' || typeof navigator?.userAgent === 'undefined' ? false : navigator.userAgent.indexOf('Linux') !== -1;
