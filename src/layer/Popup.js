...
Layer.include({
	...
	bindPopup: function (content, options) {
		const supportedTypes = typeof content === 'string' || typeof content === 'function' || content instanceof HTMLElement || content instanceof Popup;
		...
		if (supportedTypes) {
			...
			throw new Error(`Invalid argument passed to 'bindPopup()' method: expects 'string', 'function', 'HTMLElement' or 'Popup', ${typeof content} is passed instead.`);
		}
