...
* avoid double borders on abbr (by [@brunob](https://github.com/brunob)) [#4663](https://github.com/Leaflet/Leaflet/pull/4663)
...
* Prevents L.DomUtil.create() from automatically setting the class name… (by [@MuellerMatthew](https://github.com/MuellerMatthew)) [#4563](https://github.com/Leaflet/Leaflet/pull/4563)
...
* Scale down getWheelDelta() in win+chrome and ffx+retina, should fix #4538 (by [@IvanSanchez](https://github.com/IvanSanchez)) [#4557](https://github.com/Leaflet/Leaflet/pull/4557)
* Prevent listeners from being called when all listeners are removed (by [@perliedman](https://github.com/perliedman)) [#4555](https://github.com/Leaflet/Leaflet/pull/4555)
...
* Fixed L.Control.removeLayer() raising when trying to remove a layer not yet added (by [@jieter](https://github.com/jieter)) [#4487](https://github.com/Leaflet/Leaflet/pull/4487)
* Ignore events if Draggable is disabled, fixing disabling drag on click in IE11 (by [@perliedman](https://github.com/perliedman)) [#4479](https://github.com/Leaflet/Leaflet/pull/4479)
