...
* Fixed bug when adding/removing a layer from Control.Layer that is not on the map (by [@errebenito](https://github.com/errebenito)) [#4280](https://github.com/Leaflet/Leaflet/pull/4280)
