...
* Add deprecation notice for `L.Mixin.Events`, fixes [#5358](https://github.com/leaflet/leaflet/issue/5358) ([#5365](https://github.com/leaflet/leaflet/issue/5365)) (by [perliedman](https://github.com/perliedman))
* Turn `nonBubblingEvents` into a documented boolean option ([#4883](https://github.com/leaflet/leaflet/issue/4883) by [IvanSanchez](https://github.com/IvanSanchez))
* Add `L.transformation` factory, allow creation from array ([#5282](https://github.com/leaflet/leaflet/issue/5282) by [anetz89](https://github.com/anetz89))

### Docs & Web Site

* `reference.html` now always points to latest stable docs ([#5490](https://github.com/leaflet/leaflet/issue/5490) by [IvanSanchez](https://github.com/IvanSanchez), [#5493](https://github.com/leaflet/leaflet/issue/5493) by [alyhegazy](https://github.com/alyhegazy))
* subresource integrity information and scripts ([#5468](https://github.com/leaflet/leaflet/issue/5468) by [IvanSanchez](https://github.com/IvanSanchez))
* New tutorial on zooming (by [IvanSanchez](https://github.com/IvanSanchez), [#5007](https://github.com/leaflet/leaflet/issue/5007))
...
* ES6 modules & Rollup ([#4989](https://github.com/leaflet/leaflet/issue/4989)) (by [mourner](https://github.com/mourner) and [IvanSanchez](https://github.com/IvanSanchez))
* Additional fixes, testing and cleanup of ES6 code by [thachhoang](https://github.com/thachhoang), [danzel](https://github.com/danzel), [jkuebart](https://github.com/jkuebart), [simon04](https://github.com/simon04), [perliedman](https://github.com/perliedman), [luiscamachopt](https://github.com/luiscamachopt) and [Trufi](https://github.com/Trufi) ([#5373](https://github.com/leaflet/leaflet/issue/5373), [#5417](https://github.com/leaflet/leaflet/issue/5417), [#5351](https://github.com/leaflet/leaflet/issue/5351), [#5330](https://github.com/leaflet/leaflet/issue/5330), [#5329](https://github.com/leaflet/leaflet/issue/5329), [#5489](https://github.com/leaflet/leaflet/issue/5489), [#5504](https://github.com/leaflet/leaflet/issue/5504), [#5456](https://github.com/leaflet/leaflet/issue/5456), [#5463](https://github.com/leaflet/leaflet/issue/5463))

### Bug fixes

* Handle edge case of empty bounds on `_getBoundsCenterZoom` ([#5157](https://github.com/leaflet/leaflet/issue/5157) by [IvanSanchez](https://github.com/IvanSanchez))
* Add new methods to `L.Bounds` for 2 missing corners, fixes [#5475](https://github.com/leaflet/leaflet/issue/5475) ([#5488](https://github.com/leaflet/leaflet/issue/5488) by [ghybs](https://github.com/ghybs))
* Handle `Polyline`s with empty array of `LatLng`s, [#5497](https://github.com/leaflet/leaflet/issue/5497) ([#5498](https://github.com/leaflet/leaflet/issue/5498), by [perliedman](https://github.com/perliedman))
* Take `devicePixelRatio` into account for scrollwheel zoom in win10+chrome ([#5480](https://github.com/leaflet/leaflet/issue/5480)) (by [IvanSanchez](https://github.com/IvanSanchez))
* Add hook points to allow for a proper NoGap plugin ([#5476](https://github.com/leaflet/leaflet/issue/5476)) (by [IvanSanchez](https://github.com/IvanSanchez))
* Sanity check to prevent loading tiles when bounds are `Infinity` ([#5478](https://github.com/leaflet/leaflet/issue/5478), [#5479](https://github.com/leaflet/leaflet/issue/5479) by [IvanSanchez](https://github.com/IvanSanchez))
* Fix box zoom race condition ([#5452](https://github.com/leaflet/leaflet/issue/5452) by [ppaskaris](https://github.com/ppaskaris))
* On update set current tiles active to avoid pruning ([#5381](https://github.com/leaflet/leaflet/issue/5381)) ([#5431](https://github.com/leaflet/leaflet/issue/5431) by [oliverheilig](https://github.com/oliverheilig))
* make `L.Mixin.Events` a simple object instead of a prototype so it doesn't have a 'constructor' property, fixes [#5451](https://github.com/leaflet/leaflet/issue/5451) ([#5453](https://github.com/leaflet/leaflet/issue/5453) by [luiscamachopt](https://github.com/luiscamachopt))
* Canvas: call `ctx.setLineDash` in `_fillStroke` [#5182](https://github.com/leaflet/leaflet/issue/5182) ([#5454](https://github.com/leaflet/leaflet/issue/5454) by [TeXitoi](https://github.com/TeXitoi))
* Only rearrange DOM in `toFront`/`toBack` if needed, fixes [#4050](https://github.com/leaflet/leaflet/issue/4050) ([#5465](https://github.com/leaflet/leaflet/issue/5465) by [perliedman](https://github.com/perliedman))
* Push back keyboard navigation order of `L.Popup`'s close button ([#5461](https://github.com/leaflet/leaflet/issue/5461) by [Mirodil](https://github.com/Mirodil))
* Remove spurious check in `DomUtil.preventOutline` ([#5435](https://github.com/leaflet/leaflet/issue/5435) by [qjas](https://github.com/qjas))
* Add new class `L.VideoOverlay` ([#4988](https://github.com/leaflet/leaflet/issue/4988) by [IvanSanchez](https://github.com/IvanSanchez))
* Added z-index support to ImageOverlay ([#5418](https://github.com/leaflet/leaflet/issue/5418) by [Saulzi](https://github.com/Saulzi))
* Added error event to `ImageOverlay` layer and added tests for the new ([#5416](https://github.com/leaflet/leaflet/issue/5416) by [Saulzi](https://github.com/Saulzi))
* Error handler in `ImageOverlay` for 404 links ([#5307](https://github.com/leaflet/leaflet/issue/5307))
* Ensure renderer's container is initialized when a path is added to map ([#5404](https://github.com/leaflet/leaflet/issue/5404) by [IvanSanchez](https://github.com/IvanSanchez))
* Layers Control only add layer events to layers when we are on the map. Fixes [#5421](https://github.com/leaflet/leaflet/issue/5421) ([#5422](https://github.com/leaflet/leaflet/issue/5422) by [danzel](https://github.com/danzel))
* Layers Control can now become scrollable even if `collapsed: false`, fixes [#5328](https://github.com/leaflet/leaflet/issue/5328) ([#5348](https://github.com/leaflet/leaflet/issue/5348) by [ghybs](https://github.com/ghybs))
* Stop map on drag start instead of pointer down, fixes [#5350](https://github.com/leaflet/leaflet/issue/5350) ([#5378](https://github.com/leaflet/leaflet/issue/5378) by [perliedman](https://github.com/perliedman))
* fix invalid GeoJSON produced by nested `LayerGroups` ([#5359](https://github.com/leaflet/leaflet/issue/5359) by [Resonance1584](https://github.com/Resonance1584))
* Update toolbar inner border radius ([#5361](https://github.com/leaflet/leaflet/issue/5361) by [newmanw](https://github.com/newmanw))
* Export `lastId` in `Util` ([#5349](https://github.com/leaflet/leaflet/issue/5349) by [DenisCarriere](https://github.com/DenisCarriere))
...
* Docs: remove `iframe` borders on examples ([#5327](https://github.com/leaflet/leaflet/issue/5327)) (by [tariqksoliman](https://github.com/tariqksoliman))
* Pull `min`/`maxNativeZoom` from `TileLayer` into `GridLayer`, as per [#5316](https://github.com/leaflet/leaflet/issue/5316). ([#5319](https://github.com/leaflet/leaflet/issue/5319) by [jkuebart](https://github.com/jkuebart))
* Disable click propagation on zoom control buttons, fixes [#5308](https://github.com/leaflet/leaflet/issue/5308) ([#5318](https://github.com/leaflet/leaflet/issue/5318) by [perliedman](https://github.com/perliedman))
* Add CSS for `-webkit-tap-highlight-color`, fixes [#5302](https://github.com/leaflet/leaflet/issue/5302 by [IvanSanchez](https://github.com/IvanSanchez))
* Removed type attribute in HTML5 files ([#5309](https://github.com/leaflet/leaflet/issue/5309) by [uzerus](https://github.com/uzerus))
* add margin to `LatLngBounds.equals` method ([#5071](https://github.com/leaflet/leaflet/issue/5071) by [miguelcobain](https://github.com/miguelcobain))
* add `L.Draggable` options and fix docstring ([#5301](https://github.com/leaflet/leaflet/issue/5301) by [IvanSanchez](https://github.com/IvanSanchez))
* Fix max/min calculation for `getBoundsZoom`, fixes [#5136](https://github.com/leaflet/leaflet/issue/5136) ([#5137](https://github.com/leaflet/leaflet/issue/5137) by [IvanSanchez](https://github.com/IvanSanchez))
* Scrubbing of detached DOM elements, prevents memory leaks; fixes [#5263](https://github.com/leaflet/leaflet/issue/5263) ([#5265](https://github.com/leaflet/leaflet/issue/5265) by [IvanSanchez](https://github.com/IvanSanchez))
* Remove `marker.dragging` when not on the map, fixes [#5293](https://github.com/leaflet/leaflet/issue/5293) ([#5295](https://github.com/leaflet/leaflet/issue/5295) by [danzel](https://github.com/danzel))
* Stop scroll propagation in `L.Layers.Control` in chrome>55 ([#5280](https://github.com/leaflet/leaflet/issue/5280) by [IvanSanchez](https://github.com/IvanSanchez))
