...
* Support dashArray in canvas (by [@gommo](https://github.com/gommo)) [#4173](https://github.com/Leaflet/Leaflet/pull/4173)
...
* Cast `L.DivIcon.bgPos` to L.Point (by [@perliedman](https://github.com/perliedman)) [#4090](https://github.com/Leaflet/Leaflet/pull/4090)
...
* Fractional zoom controls (by [@IvanSanchez](https://github.com/IvanSanchez)) [#3523](https://github.com/Leaflet/Leaflet/pull/3523)
...
* Fixed zoom event firef twice (by [@perliedman](https://github.com/perliedman)) [#4367](https://github.com/Leaflet/Leaflet/pull/4367)
...
* Fixed bug when ading/removing a layer from Control.Layer that is not on the map (by [@errebenito](https://github.com/errebenito)) [#4280](https://github.com/Leaflet/Leaflet/pull/4280)
...
* Better cleanup of L.Control.Layers, fixes #4213 (plus unit tests) (by [@IvanSanchez](https://github.com/IvanSanchez)) [#4214](https://github.com/Leaflet/Leaflet/pull/4214)
...
* Fixed precision issues in circle radius (by [@IvanSanchez](https://github.com/IvanSanchez)) [#4133](https://github.com/Leaflet/Leaflet/pull/4133)
...
* Fixed CSS warning in Safari (by [@jgravois](https://github.com/jgravois)) [#4122](https://github.com/Leaflet/Leaflet/pull/4122)
* Use all projected coords when calculating Polyline's pixel bounds. (by [@perliedman](https://github.com/perliedman)) [#4114](https://github.com/Leaflet/Leaflet/pull/4114)
...
* Fixed duplicated code in `L.GriLayer.retainParent` (by [@jblarsen](https://github.com/jblarsen)) [#4094](https://github.com/Leaflet/Leaflet/pull/4094)
...
* Fixed event target fallbacking to map after marker drag (fix #3971) (by [@yohanboniface](https://github.com/yohanboniface)) [#4010](https://github.com/Leaflet/Leaflet/pull/4010)
...
* Skip _updateLevels when out of min/max zoom (prevents IE8 exceptions) (by [@IvanSanchez](https://github.com/IvanSanchez)) [#3999](https://github.com/Leaflet/Leaflet/pull/3999)
