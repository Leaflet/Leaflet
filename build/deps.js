var deps = {
	...
	PolyDraw: {
	  src: ['handler/PolyDraw.js'],
	  desc: 'Enables drawing of Polyline and Polygon objects.'
	},

	PolyEdit: {
	  src: ['handler/PolyEdit.js'],
	  desc: 'Enables editing of Polyline and Polygon objects.'
	},
