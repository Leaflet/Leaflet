...
describe("Projection.Mercator", () => {
  ...
  describe("#project", () => {
    ...
    it("projects the northeast corner of the world", () => {
      expect(p.project(new LatLng(85.0840591556, 180))).near([
        20037508, 20037508,
      ]);
    });
  ...
  describe("#unproject", () => {
    ...
    it("unprojects pi points", () => {
      ...
      expect(pr(new Point(0.523598775598, 1.010683188683))).near([
        0.523598775598, 1.010683188683,
      ]);
    });
...
describe("Projection.SphericalMercator", () => {
  ...
  describe("#project", () => {
    ...
    it("projects the northeast corner of the world", () => {
      expect(p.project(new LatLng(85.0511287798, 180))).near([
        20037508, 20037508,
      ]);
    });
