describe("Map", function () {
	...
	describe("#DOM events", function () {
		...
		it("prevents default action of contextmenu if there is any listener", function () {
			...
			// first
			happen.at('contextmenu', 0, 0);

			// second  (#5995)
			happen.at('contextmenu', marker._point.x, marker._point.y);

			document.body.removeChild(container); // cleanup

			expect(spy.firstCall.lastArg.originalEvent.defaultPrevented);
			expect(spy.secondCall.lastArg.originalEvent.defaultPrevented);
		});
	});
